...
# Ensure project root is on sys.path so root-level modules
# (download, transcribe, export, highlight, utils.*, sync, etc.)
# are importable from anywhere inside the automation package.
